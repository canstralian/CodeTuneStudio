...
class CodeAnalyzerTool(AgentTool):
    ...
    using the Abstract Syntax Tree (AST) module. It extracts metrics such as
    the number of functions, classes, imports, and a simple complexity score
    based on the total number of AST nodes.
    ...
    Methods:
        ...
        validate_inputs(inputs: dict[str, Any]) -> bool:
            Validates that the input dictionary contains a 'code' key with
            a string value.
