...
class StructuredFormatter(logging.Formatter):
    """
    Custom formatter that provides structured log output with color support
    in terminals.
    """
...
def setup_logging(
    ...
    Args:
        log_level: Logging level (DEBUG, INFO, WARNING, ERROR, CRITICAL).
                  If None, reads from LOG_LEVEL environment variable or
                  defaults to INFO.
        log_file: Optional path to log file. If provided, logs are also
                  written to file.
